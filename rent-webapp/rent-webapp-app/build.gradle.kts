...
dependencies {
    ...
    implementation(project(":rent-webapp:rent-webapp-api"))
    implementation(project(":rent-contract:rent-contract-app"))
...
tasks {
    docker {
        name = "registry.weintegrator.com/image/${project.name}"
